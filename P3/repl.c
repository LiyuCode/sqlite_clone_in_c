...
int main(int argc, char *argv[])
{
    ...
    while (true)
    {
        ...
        // BM: Step 1, add support to two new keywords
        // if(strcmp(input_buffer->buffer,".exit") == 0){
        //     close_input_buffer(input_buffer);
        //     exit(EXIT_SUCCESS);
        // }else{
        ...
        // }
        //// BM: the first kind are of Non-SQL statemetns like '.exit', named 'Meta-commands';
        ...
        //// BM: the 2nd kind are of SQL statemetns like 'selct' and 'insert';
        ...
        case (PREPARE_UNRECOGNIZED_STATEMENT):
            printf("Unrecognized keywords at start of '%s'.\n", input_buffer->buffer);
            continue;
        }
